...
<b>Sequelize:</b>
->Generate Models from existing mysql db : 
...
<b>Mysql:</b>
->Generate Routes from typed models : 
- dbCrud : https://github.com/johnroers/dbCRUD

->Generate Models and Routes from an existing Mysql ( Eventually no Middleware support) : 
